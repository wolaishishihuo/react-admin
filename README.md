...
React Admin 一款基于 React 19、React-Router v7、React Hooks、Zustand、TypeScript、Vite 8、Ant Design 6 的后台管理框架。

仓库：[https://github.com/wolaishishihuo/react-admin](https://github.com/wolaishishihuo/react-admin)
...
- 项目其它功能：菜单手风琴模式、无限级菜单、多标签页、详情页标签、面包屑导航、页面水印、ECharts 组件封装、SVG 图标组件、数据大屏…
