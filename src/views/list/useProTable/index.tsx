...
import { asFormRule, validatePhone } from '@/utils';
import { type ReqUserList, type UserItem } from '@/types';
import { createUser, deleteUsers, fetchUserList, updateUser } from './service';
